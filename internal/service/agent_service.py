...
from internal.core.agent.agents import BaseAgent, FunctionCallAgent, ReACTAgent
...
class AgentService:
    ...
    def create_agent(self, config: AppConfig | AppConfigVersion | dict[str, Any], app: App) \
